...
describe("globe data helpers", () => {
  ...
  it("builds wishlist markers with China filtering and full properties", () => {
    const wishlist: WishlistPoint[] = [
      { id: "1", name: "桂林", nameEn: "Guilin", nameZh: "桂林", country: "China", countryCode: "CHN", location: "Guilin · Guangxi · China", latitude: 25.2736, longitude: 110.29 },
      { id: "2", name: "里斯本", nameEn: "Lisbon", nameZh: "里斯本", country: "Portugal", countryCode: "PRT", location: "Lisbon · Portugal", latitude: 38.7223, longitude: -9.1393 },
    ];
